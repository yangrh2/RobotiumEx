...
public class ChinaNameGenerator {
	...
	public String generateFirstName(){
        ...
        String totleBName = "安,安福,安歌,安国,安和,安康,安澜,安民,安宁,安平,安然,安顺,安翔,安晏,安宜,安怡,安易,安志,一,二,三,四,五,六,七,八,九,十";
	 ...
	 * @return
	 */
	public String generateManyNames(int i){
...
//		String manyNames = g.generateManyNames(10);
